...
| Goal | Why It Matters |
|------|----------------|
| Shift from KTLO to growth mode | Unlock innovation, not just maintenance |
| Launch AI-enabled capabilities | Differentiate vs competitors |
| Expand beyond GS1 soft goods | New customers, new categories |

## Beliefs (Decision Principles)

1. **Customer value first** - Solve real user pain, not hypothetical problems
...
| Know Well | Learning |
|-----------|----------|
| B2B enterprise software | Active Catalog architecture |
| Product strategy | GS1/GTIN standards |
...
| Name | Role | What They Care About | How to Influence |
|------|------|---------------------|------------------|
...
|--------|---------|--------|--------|
| Growth within Active Catalog customer base | TBD | TBD | Baseline needed |
